...
run-docker:
	docker run -u $(id -u):$(id -g) -p 127.0.0.1:8888:8888 -v ~/work/sionna_research:/tf --privileged=true $(GPU) --env NVIDIA_DRIVER_CAPABILITIES=graphics,compute,utility --rm -it sionna
